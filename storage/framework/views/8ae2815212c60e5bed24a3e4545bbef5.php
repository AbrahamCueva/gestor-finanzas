<ul class="m-0 mr-auto flex   list-none p-0 text-slate-500 dark:text-gray-400">
    <li class="items-center flex ltr:mr-1 rtl:pl-2 gap-1 ml-2 ">
        ...
        <span class="helper-Label" ><?php echo e(__('to select')); ?></span>
    </li>
    <li class="items-center mr-1 flex ltr:mr-1 rtl:pl-2 gap-1 ml-2 ">
        ...
        <span class="helper-Label" ><?php echo e(__('to navigate')); ?></span>
    </li>
    <li class="items-center flex ltr:mr-1 rtl:pl-2 gap-1 ml-2 ">
        <span class="rounded flex  shadow-sm ring-1 transition duration-75   ring-gray-950/10 dark:ring-white/20 ">
            <kbd class="flex items-center justify-center  p-1  text-gray-700 dark:text-gray-400">
        ...
        <span class="helper-Label" ><?php echo e(__('to close')); ?></span>
    </li>
</ul>
<?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\vendor\charrafimed\global-search-modal\resources\views/components/search/footer.blade.php ENDPATH**/ ?>
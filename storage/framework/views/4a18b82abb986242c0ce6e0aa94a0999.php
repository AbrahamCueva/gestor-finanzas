...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400']); ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($count > 0): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasHidden): ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-4 h-4 mx-1 text-gray-300 dark:text-gray-600 flex-shrink-0']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-m-ellipsis-horizontal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
...
<?php endif; ?>
                ...
                >
                    <div class="flex flex-col max-h-64 overflow-y-auto w-full">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $breadcrumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index < $count - $visibleCount): ?>
                                <button
                                    type="button"
                                    wire:click.stop="setCurrentFolder(<?php echo e($breadcrumb['id']); ?>)"
                                    ...
                                    title="<?php echo e($breadcrumb['name']); ?>"
                                >
...
<?php endif; ?>
                    ...
                    <button
                        type="button"
                        wire:click.stop="setCurrentFolder(<?php echo e($breadcrumb['id']); ?>)"
                        class="truncate max-w-[120px] sm:max-w-[150px] lg:max-w-[200px] px-1 hover:text-primary-600 dark:hover:text-primary-400 transition-colors <?php echo e($loop->last ? 'text-gray-900 dark:text-gray-100 font-semibold cursor-default pointer-events-none' : ''); ?>"
                        title="<?php echo e($breadcrumb['name']); ?>"
                    >
                        <?php echo e($breadcrumb['name']); ?>
...
<?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\vendor\slimani\filament-media-manager\resources\views/components/breadcrumbs.blade.php ENDPATH**/ ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="se">
        ...
        <div class="se-card">
            ...
            <div class="se-controles">
                ...
                <div class="se-control">
                    ...
                    <div class="se-control-valor" style="color:<?php echo e($ajusteIngresos >= 0 ? '#22c55e' : '#ef4444'); ?>;">
                        <?php echo e($ajusteIngresos >= 0 ? '+' : ''); ?><?php echo e($ajusteIngresos); ?>%
                    </div>
                ...
                <div class="se-control">
                    ...
                    <div class="se-control-valor" style="color:<?php echo e($ajusteEgresos <= 0 ? '#22c55e' : '#ef4444'); ?>;">
                        <?php echo e($ajusteEgresos >= 0 ? '+' : ''); ?><?php echo e($ajusteEgresos); ?>%
                    </div>
                ...
                <div class="se-control">
                    ...
                    <div class="se-control-valor" style="color:var(--gold);"><?php echo e($ahorroPropuesto); ?>%</div>
                ...
                <div class="se-control">
                    ...
                    <div class="se-control-valor" style="color:var(--blue);"><?php echo e($mesesProyeccion); ?> meses</div>
        ...
        <div class="se-objetivo <?php echo e($sim['cumpleObjetivo'] ? 'cumple' : 'falta'); ?>">
            <div style="font-size:1.5rem;"><?php echo e($sim['cumpleObjetivo'] ? '✅' : '⚠️'); ?></div>
            <div>
                <div
                    style="font-size:.875rem; font-weight:700; color:<?php echo e($sim['cumpleObjetivo'] ? '#22c55e' : '#fbbf24'); ?>;">
                    <?php echo e($sim['cumpleObjetivo'] ? '¡Cumples tu objetivo de ahorro del ' . $ahorroPropuesto . '%!' : 'No alcanzas tu objetivo de ahorro del ' . $ahorroPropuesto . '%'); ?>

                </div>
                <div style="font-size:.72rem; color:var(--muted); margin-top:.15rem;">
                    Ahorro necesario: S/ <?php echo e(number_format($sim['ahorroObjetivo'], 2)); ?>/mes ·
                    Ahorro simulado: S/ <?php echo e(number_format($sim['ahorroMensual'], 2)); ?>/mes
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$sim['cumpleObjetivo']): ?>
                        · Te faltan S/ <?php echo e(number_format($sim['ahorroObjetivo'] - $sim['ahorroMensual'], 2)); ?>/mes
        ...
        <div class="se-comparativa">
            <div class="se-comp-card actual">
                ...
                <div class="se-comp-row">
                    ...
                    <span class="se-comp-value" style="color:var(--green);">S/
                        <?php echo e(number_format($base['ingresos'], 2)); ?></span>
                </div>
                <div class="se-comp-row">
                    <span class="se-comp-label">Egresos</span>
                    <span class="se-comp-value" style="color:var(--red);">S/
                        <?php echo e(number_format($base['egresos'], 2)); ?></span>
                </div>
                <div class="se-comp-row"
                    ...
                    <span class="se-comp-value" style="color:var(--blue);">S/
                        <?php echo e(number_format($base['ingresos'] - $base['egresos'], 2)); ?></span>
                </div>
            </div>
            ...
            <div class="se-comp-card simulado">
                ...
                <div class="se-comp-row">
                    <span class="se-comp-label">Ingresos</span>
                    <span class="se-comp-value" style="color:var(--green);">S/
                        <?php echo e(number_format($sim['ingresosNuevos'], 2)); ?></span>
                </div>
                <div class="se-comp-row">
                    <span class="se-comp-label">Egresos</span>
                    <span class="se-comp-value" style="color:var(--red);">S/
                        <?php echo e(number_format($sim['egresosNuevos'], 2)); ?></span>
                </div>
                <div class="se-comp-row"
                    style="border-top:1px solid var(--border); padding-top:.35rem; margin-top:.35rem;">
                    <span class="se-comp-label">Ahorro (<?php echo e($sim['pctAhorro']); ?>%)</span>
                    <span class="se-comp-value"
                        style="color:<?php echo e($sim['ahorroMensual'] >= 0 ? 'var(--blue)' : 'var(--red)'); ?>;">
                        S/ <?php echo e(number_format($sim['ahorroMensual'], 2)); ?>
            ...
            <div class="se-comp-card diferencia">
                ...
                <div class="se-comp-row">
                    <span class="se-comp-label">Ingresos</span>
                    <span class="se-comp-value"
                        style="color:<?php echo e(($sim['ingresosNuevos'] - $base['ingresos']) >= 0 ? 'var(--green)' : 'var(--red)'); ?>;">
                        <?php echo e(($sim['ingresosNuevos'] - $base['ingresos']) >= 0 ? '+' : ''); ?>S/
                        <?php echo e(number_format($sim['ingresosNuevos'] - $base['ingresos'], 2)); ?>
                ...
                <div class="se-comp-row">
                    <span class="se-comp-label">Egresos</span>
                    <span class="se-comp-value"
                        style="color:<?php echo e(($sim['egresosNuevos'] - $base['egresos']) <= 0 ? 'var(--green)' : 'var(--red)'); ?>;">
                        <?php echo e(($sim['egresosNuevos'] - $base['egresos']) >= 0 ? '+' : ''); ?>S/
                        <?php echo e(number_format($sim['egresosNuevos'] - $base['egresos'], 2)); ?>
                ...
                <div class="se-comp-row"
                    ...
                    <span class="se-comp-value"
                        style="color:<?php echo e($sim['diferenciaAhorro'] >= 0 ? 'var(--purple)' : 'var(--red)'); ?>;">
                        <?php echo e($sim['diferenciaAhorro'] >= 0 ? '+' : ''); ?>S/
                        <?php echo e(number_format($sim['diferenciaAhorro'], 2)); ?>
        ...
        <div class="se-card">
            <div class="se-title">📈 Proyección de saldo — <?php echo e($mesesProyeccion); ?> meses</div>
        ...
        <div class="se-card">
            ...
            <div style="overflow-x:auto;">
                <table class="se-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sim['proyeccion']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fila): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                ...
                                <td
                                    ...
                                    <?php echo e(number_format($fila['saldo'] - $fila['saldoBase'], 2)); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            renderChart(<?php echo json_encode($sim['proyeccion'], 15, 512) ?>);
        });
    </script>
...
<?php endif; ?><?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\resources\views/filament/pages/simulador-escenarios.blade.php ENDPATH**/ ?>
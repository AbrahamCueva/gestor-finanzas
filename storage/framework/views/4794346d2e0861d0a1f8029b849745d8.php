...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="dr">
        ...
        <div class="dr-card">
            ...
            <div class="dr-base">
                <div class="dr-base-item">
                    ...
                    <div class="dr-base-value" style="color:#22c55e;">S/ <?php echo e(number_format($d['ingresosProm'], 2)); ?>

                    </div>
                </div>
                <div class="dr-base-item">
                    <div class="dr-base-label">Egresos promedio</div>
                    <div class="dr-base-value" style="color:#ef4444;">S/ <?php echo e(number_format($d['egresosProm'], 2)); ?></div>
                </div>
                <div class="dr-base-item">
                    <div class="dr-base-label">Ahorro promedio</div>
                    <div class="dr-base-value" style="color:<?php echo e($d['ahorroProm'] >= 0 ? '#60a5fa' : '#ef4444'); ?>;">
                        S/ <?php echo e(number_format($d['ahorroProm'], 2)); ?>
        ...
        <div class="dr-card">
            ...
            <div class="dr-patrimonio">
                <div class="dr-pat-item">
                    ...
                    <div class="dr-pat-value" style="color:#22c55e;">S/ <?php echo e(number_format($d['totalActivos'], 2)); ?></div>
                </div>
                <div style="font-size:1.25rem; color:var(--muted);">−</div>
                <div class="dr-pat-item">
                    <div class="dr-pat-label">Total deudas</div>
                    <div class="dr-pat-value" style="color:#ef4444;">S/ <?php echo e(number_format($d['totalDeudas'], 2)); ?></div>
                </div>
                <div style="font-size:1.25rem; color:var(--muted);">=</div>
                <div class="dr-pat-item">
                    <div class="dr-pat-label">Patrimonio neto</div>
                    <div class="dr-pat-value"
                        style="color:<?php echo e($d['patrimonioNeto'] >= 0 ? '#fbbf24' : '#ef4444'); ?>; font-size:1.25rem;">
                        S/ <?php echo e(number_format($d['patrimonioNeto'], 2)); ?>
        ...
        <div class="dr-card">
            ...
            <div class="dr-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $d['ratios']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    <div class="dr-ratio <?php echo e($r['estado']); ?>">
                        <div class="dr-ratio-bg"></div>
                        <div class="dr-ratio-header">
                            <div class="dr-ratio-left">
                                <span class="dr-ratio-emoji"><?php echo e($r['emoji']); ?></span>
                                <span class="dr-ratio-nombre"><?php echo e($r['nombre']); ?></span>
                            </div>
                            <span class="dr-ratio-badge"><?php echo e($estadoLabel); ?></span>
                        </div>

                        <div class="dr-ratio-valor"><?php echo e($valorDisplay); ?></div>
                        <div class="dr-ratio-desc"><?php echo e($r['desc']); ?></div>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r['meta'] !== null): ?>
                            <div class="dr-prog-wrap">
                                <div class="dr-prog-track">
                                    <div class="dr-prog-fill" style="width:<?php echo e(round($prog)); ?>%;"></div>
                                </div>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <div class="dr-ratio-benchmark"><?php echo e($r['benchmark']); ?></div>
                    </div>
    ...
    <script>
        function initDrChart() {
            const historial = <?php echo json_encode($d['historial'], 15, 512) ?>;
...
<?php endif; ?><?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\resources\views/filament/pages/dashboard-ratios.blade.php ENDPATH**/ ?>
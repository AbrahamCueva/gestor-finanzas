...
<body>
    ...
    <div class="wrap">
        <div class="card">
            ...
            <div class="secret-wrap"><?php echo e($user->two_factor_secret); ?></div>

            <form method="POST" action="<?php echo e(route('2fa.setup.post')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\resources\views/2fa/setup.blade.php ENDPATH**/ ?>
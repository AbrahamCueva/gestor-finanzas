...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="pb-wrap">
        ...
        <div class="pb-header">
            ...
            <div class="pb-badges">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($superados > 0): ?>
                    <span class="pb-badge" style="background:rgba(239,68,68,0.12); color:#f87171;">
                        ...
                        <?php echo e($superados); ?> crítico<?php echo e($superados > 1 ? 's' : ''); ?>

                    </span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($en_alerta > 0): ?>
                    <span class="pb-badge" style="background:rgba(245,158,11,0.12); color:#fbbf24;">
                        ...
                        <?php echo e($en_alerta); ?> en alerta
                    </span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($superados === 0 && $en_alerta === 0 && $total > 0): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $presupuestos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    ...
                    <div class="pb-card">
                        <div class="pb-card-header">
                            <div>
                                <div class="pb-card-period"><?php echo e($p['periodo']); ?></div>
                                <div class="pb-card-name"><?php echo e($p['nombre']); ?></div>
                            </div>
                            <div class="pb-card-dates"><?php echo e($p['fecha_inicio']); ?><br><?php echo e($p['fecha_fin']); ?></div>
                        </div>

                        <div>
                            <div class="pb-progress-header">
                                <span class="pb-progress-consume">Consumo</span>
                                <span class="pb-progress-pct" style="color:<?php echo e($bc); ?>;">
                                    <?php echo e(min($p['porcentaje'], 100)); ?>%
                                </span>
                            </div>
                            <div class="pb-track">
                                <div class="pb-fill"
                                    style="width:<?php echo e(min($p['porcentaje'], 100)); ?>%; background:<?php echo e($bc); ?>;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pb-metrics">
                            <div>
                                ...
                                <div class="pb-metric-value">S/ <?php echo e(number_format($p['gasto'], 2)); ?></div>
                            </div>
                            <div>
                                <div class="pb-metric-label">Límite</div>
                                <div class="pb-metric-value">S/ <?php echo e(number_format($p['limite'], 2)); ?></div>
                            </div>
                            <div>
                                <div class="pb-metric-label">Disponible</div>
                                <div class="pb-metric-value"
                                    style="color:<?php echo e($p['disponible'] < 0 ? '#ef4444' : '#22c55e'); ?>;">
                                    <?php echo e($p['disponible'] < 0 ? '-' : ''); ?>S/
                                    <?php echo e(number_format(abs($p['disponible']), 2)); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\resources\views/filament/widgets/presupuestos-dashboard.blade.php ENDPATH**/ ?>
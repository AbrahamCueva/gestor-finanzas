                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fila['ingresos'] > 0 || $fila['egresos'] > 0 || !$fila['esFuturo']): ?>
                                <tr class="<?php echo e($fila['esFuturo'] ? 'futuro' : ''); ?>">
                                    <td style="font-weight:700; color:var(--text);">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fila['esFuturo']): ?>
    ...
    <script>
        (function() {
            ...
            document.addEventListener('DOMContentLoaded', () => {
                renderFcChart(<?php echo json_encode($d['flujo'], 15, 512) ?>);
            });

            // Re-render por navegación Livewire
            document.addEventListener('livewire:navigated', () => {
                setTimeout(() => renderFcChart(<?php echo json_encode($d['flujo'], 15, 512) ?>), 80);
            });
        })();
    </script>
...
<?php endif; ?>
<?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\resources\views/filament/pages/flujo-caja.blade.php ENDPATH**/ ?>
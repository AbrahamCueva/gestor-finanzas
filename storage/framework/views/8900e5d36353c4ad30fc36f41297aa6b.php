...
<div class="particles">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < 20; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
        <div class="particle" style="
            ...
            --dur: <?php echo e(rand(6, 14)); ?>s;
            --delay: <?php echo e(rand(0, 8)); ?>s;
            width: <?php echo e(rand(1, 3)); ?>px;
            height: <?php echo e(rand(1, 3)); ?>px;
            opacity: <?php echo e(rand(2, 6) / 10); ?>;
        "></div>
...
<div class="container">
    ...
    <div class="logo-wrap">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings?->logo_dark): ?>
            <?php
                $path = storage_path('app/public/' . $settings->logo_dark);
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(file_exists($path)): ?>
                <img src="<?php echo e(asset('storage/' . $settings->logo_dark)); ?>" style="height:32px; width:auto;" alt="logo">
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <span class="logo-text"><?php echo e($settings?->site_name ?? 'RICOX'); ?></span>
    </div>
...
<?php /**PATH C:\Users\ricoa\Documents\gestor-finanzas\resources\views/errors/404.blade.php ENDPATH**/ ?>
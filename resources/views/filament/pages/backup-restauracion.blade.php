<x-filament-panels::page>
    ...
    <div class="br-wrap">
        ...
        @if ($error)
            <div class="br-error">⚠️ {{ $error }}</div>
        @endif
    ...
    <script>
        function leerJson(event) {
            ...
            reader.onload = e => @this.call('procesarJson', e.target.result);
        ...
        if (dz) {
            ...
            dz.addEventListener('drop', e => {
                ...
                if (file) {
                    const reader = new FileReader();
                    reader.onload = ev => @this.call('procesarJson', ev.target.result);
                    reader.readAsText(file, 'UTF-8');
                }
            });
        }

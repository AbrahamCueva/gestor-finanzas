    ...
    <div class="ia-wrap">
        ...
        <div class="ia-header">
            <div>
                ...
                <div class="ia-title">{{ strtoupper($mes) }}</div>
            </div>
            <div style="display:flex; flex-direction:column; align-items:flex-end; gap:0.75rem;">
                ...
                <div>
                    ...
                    <div class="ia-balance-value">S/ {{ number_format($saldoTotal, 2) }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="ia-metrics">
            ...
            <div class="ia-metric">
                <div class="ia-metric-icon"
                    style="background:rgba({{ $isPositive ? '34,197,94' : '239,68,68' }},0.12);">
                ...
                <div class="ia-metric-value" style="color:{{ $isPositive ? '#22c55e' : '#ef4444' }};">
                    S/ {{ number_format(abs($ahorro), 2) }}
                </div>
                <div class="ia-metric-sub" style="color:{{ $isPositive ? '#16a34a' : '#dc2626' }};">
                    {{ $isPositive ? 'Surplus' : 'Déficit' }}
                </div>
            </div>
            ...
            <div class="ia-metric">
                ...
                <div class="ia-metric-value" style="color:#22c55e;">S/ {{ number_format($ingresos, 2) }}</div>
            </div>
            ...
            <div class="ia-metric">
                ...
                <div class="ia-metric-value" style="color:#ef4444;">S/ {{ number_format($egresos, 2) }}</div>
            </div>
        ...
        <div class="ia-progress-wrap">
            <div class="ia-progress-header">
                <div class="ia-progress-label" style="color:{{ $isPositive ? '#22c55e' : '#ef4444' }};">
                    {{ $label }}
                </div>
                <div class="ia-progress-pct">{{ $porcentaje }}%</div>
            </div>
            <div class="ia-progress-track">
                <div class="ia-progress-fill"
                    style="width:{{ min($porcentaje, 100) }}%; background:{{ $isPositive ? '#22c55e' : '#ef4444' }};">
                </div>
            </div>
        </div>

...
<head>
    ...
    <title>403 — Página no encontrada</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="titulo">Acceso Denegado</div>
        <div class="descripcion">
            No tienes permisos para acceder a esta sección.<br>
            Si crees que se trata de un error, contacta con el administrador o verifica tus credenciales.
        </div>
